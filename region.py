...
class Region:
    ...
    def set_view(self, root_view: tk.Canvas=None, _x=0, _y=0):
        if isinstance(root_view, tk.Canvas):
            ...
            # For making space to place "player's Marker"
    ...
    def reset(self):
        self.__owner = None  # reset region owner
    ...
    # change owner. but none can buy desert
    ...
    # return buy type.(within constant.py)
    ...
    # get current price of the region.
    def get_current_price(self):
        return self.__current_price


# Implement view of Region.
