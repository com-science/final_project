...
class Player:
    ...
    # initialize player information. (needs when game resets)
    def reset(self):
    ...
    # dice1, dice2 values make player move (dice1+dice2) region, and return new position dice1+dice2 .
    ...
    # when paying successes, return True. otherwise, return false
...
class Marker:
    ...
    # make marker move as distance. and return number of passing starting point
